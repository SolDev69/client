...
export class DataReader extends DataView{
	...
	uint64(){ return this.getUint64((this.i+=4)-4) }
	int64(){ return this.getInt64((this.i+=4)-4) }
...
export class DataWriter extends Array{
	...
	write(type, v){
		...
		switch(type){
			...
			case Uint64: buf.setBigUint64((this.i += 8) - 8, v); return
			case Int64: buf.setBigInt64((this.i += 8) - 8, v); return
	...
	uint64(n){ if(this.i > this.cur.byteLength - 8)this.allocnew(); this.cur.setBigUint64((this.i+=8)-8, n) }
	int64(n){ if(this.i > this.cur.byteLength - 8)this.allocnew(); this.cur.setBigInt64((this.i+=8)-8, n) }
